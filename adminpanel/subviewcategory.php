...
<body>
    ...
    <table class="table">
        ...
        <tbody>
            <!-- php code -->
            <?php
     $showQuery = mysqli_query($connection, "SELECT * FROM sub_category");
     foreach($showQuery as $data){
        ?>
            <tr class="text-center">
                <th scope="row"><?php echo $data['subcat_id']?></th>
                <td><?php echo $data['subcat_name']?></td>
                <td><img src="../images/<?php echo $data['subcat_image']?>" alt="Not Found" width="100px"></td>
                <br>
                <td>
                    <!-- delete modal button code -->
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                        data-bs-target="#delete<?php echo $data['subcat_id'] ?>">
                        Delete
                    </button>
                    <!-- update modal code button -->
                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                        data-bs-target="#update<?php echo $data['subcat_id'] ?>">
                        Update
                    </button>
            ...
            <!-- Delete Modal code  -->
            <div class="modal fade" id="delete<?php echo $data['subcat_id'] ?>" tabindex="-1"
                aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="../code.php" method="post">
                            <div class="modal-body">
                                <h5>Are you sure you want to delete <?php echo $data['subcat_name']?> data???</h5>
...
<!-- update modal code -->
            <div class="modal fade" id="update<?php echo $data['subcat_id'] ?>" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="../code.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <input type="hidden" name="cat_id" value="<?php echo $data['subcat_id'] ?>">

                                <label>Category Name:</label>
                                <input type="text" name="updateCatName" class="form-control mb-3"
                                    value="<?php echo $data['subcat_name'] ?>">
